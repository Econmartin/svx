...
|---|---|---|
| **Divergence-mint** (Predict favored side at ≥8pp divergence) | **LIVE** (testnet dUSDC; paper on mainnet until Predict ships Sui mainnet) | The flagship Predict-mainnet strategy, added 2026-07-10: when the venues disagree by ≥8pp, Predict's favorite (the >50¢ side) is directionally right but underconfident — quoted ~74–84¢, it realizes 84–94%. Validated on two disjoint windows (May-2026: 94% win/+11.9% ROI; July-2026: 87.5%/≈+18.5%; deduped, 2% fee) — see [docs/backtest-report.md](docs/backtest-report.md). One bet per oracle, fixed clips, daily loss standdown. |
